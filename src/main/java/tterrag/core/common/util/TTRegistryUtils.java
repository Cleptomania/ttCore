...
public class TTRegistryUtils {
     ...
     * registering items to modids other
     ...
     */
    @SneakyThrows
    public void registerBlock(Block block, Class<? extends ItemBlock> itemclass, String modid, String name,
        Object... itemCtorArgs) {
        if (Loader.instance()
            .isInState(LoaderState.CONSTRUCTING)) {
            FMLLog.warning(
